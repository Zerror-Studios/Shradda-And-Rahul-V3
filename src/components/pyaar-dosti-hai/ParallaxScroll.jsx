...
// // Same image count on every device (mobile and desktop both use 64).
// const BACKGROUND_IMAGE_COUNT = 64;
...
//     <div
//       ref={ref}
//       // Previously "hidden sm:block" hid these entirely on mobile.
//       // Now they render on every breakpoint (mobile included), just
//       // at a smaller size via the responsive width classes below.
...
export default function ParallaxScroll() {
  ...
  return (
    <main ref={scope} className="paren_nn relative h-[800vh] BGCLR">
      ...
      <div className="sticky_child opacity-0 scale-90 sticky pointer-events-none top-0 flex h-screen flex-col items-center z-89 justify-center gap-y-2 px-3 sm:gap-y-4 sm:px-8">
        {/* Main photo with city + year overlaid */}
        <div className="relative w-[68vw] max-w-[280px] h-[32vh]  sm:w-[36vw] sm:h-[38vh] sm:max-w-none md:w-[24vw] md:h-[50vh]">
          {DATA.map((item, i) => (
            <div
