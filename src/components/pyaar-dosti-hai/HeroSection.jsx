            ...
            <div className="relative">
              ...
              >
                <div
                  className={`
                    overflow-hidden
                    bg-[#F1E2C6] border border-[#e7ddd4] rounded-sm shadow-xl px-2 py-2
                    transition-transform duration-300 ease-out
                    ${isLanguageOpen ? "translate-y-0" : "-translate-y-2"}
                  `}
                >
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {Object.entries(translations).map(([lang, data], index) => (
                      <button
                        key={lang}
                        onClick={() => {
                          setSelectedLanguage(lang);
                        ...
                        className={`
                          flex items-center gap-[0.6rem] sm:gap-[0.8rem]
                          px-[1rem] sm:px-[1.2rem] py-[0.7rem] sm:py-[0.8rem]
                          transition-all duration-300
                          hover:bg-[#D25F27] border border-[#D25F27]/40
                        ...
                        `}
                      >
                        <span className="text-[1rem] sm:text-[1.2rem] Font_CV flex-shrink-0">{data.symbol}</span>
                        <span className="Font_CV text-[0.85rem] sm:text-[1rem] truncate">{lang}</span>
                      </button>
                    ))}
                  </div>
                </div>
