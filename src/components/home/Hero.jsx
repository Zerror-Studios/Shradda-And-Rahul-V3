...
//     // Step 1: fade + blur out every other tile
//     clickTL.to(
//       otherItems,
//       {
//         opacity: 0,
...
//     // Step 3: fast, clean spin-zoom into the page — pivoting on the tile's own center
//     clickTL.to(
//       clickedElement,
//       {
//         scale: 32,
//         rotateZ: 1080, // 3 full spins, much faster than before
//         transformOrigin: "50% 50%",
//         duration: 0.45,
//         ease: "power1.in",
//       },
...
//     // Quick fade right at the end so the cut to the next page feels seamless ==================================================================
//     // clickTL.to(
//     //   clickedElement,
//     //   {
//     //     opacity: 0,
...
//           <div ref={bgLayerRef} className="w-full h-full absolute top-0 left-0">
//             {/* Background image */}
//             <img
//               src={`/new_img/BG.jpeg`}
//               alt="Img"
